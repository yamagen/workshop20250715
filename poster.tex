...
\node[
  ...
  align=left,
  text=mydeepblue,
  font=\fontsize{40pt}{40pt}\bfseries
] at ([xshift=-3cm,yshift=-15cm]current page.north east) {
  \textbf{\fontsize{70pt}{70pt}\selectfont 
  Hilofumi Yamamoto, Ph.D. in Linguistics} \\[1em]
  \begin{flushright}
  The Australian National University\\[1em]
...
\node[
  ...
  \includegraphics[height=8cm]{images/sciencetokyo.png}
